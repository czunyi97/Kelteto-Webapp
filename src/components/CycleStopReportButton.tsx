...
function calcMinMax(data: number[]) {
  ...
  // ha lapos a görbe, adjunk fix paddinget
...
export default function CycleStopReportButton({
  ...
  async function generatePdfAndDownload(params: {
    ...
    try {
      ...
      // ha nincs logo.png, attól még menjen a PDF
    }
    ...
    const sumRows: Array<[string, string]> = [
      ...
      ["Kikelési hatásfok", efficiency], // ✅ összegzés végén
    ];
  ...
  // 🔐 dupla megerősítés: 1) gomb 2) form elküldés (már eleve megerősítés)
